...
## 📁 File: `Notebooks/Compare_viz_dataset.py`
...
“The function top_genres explodes the genre list column so each genre becomes its own row. After cleaning the values, we use value_counts() to compute the most common genres. For both HBO and Paramount, we take the top genres, concatenate them side-by-side, fill missing combinations with zero, convert to integer type, and plot a grouped bar chart.”

---

## 📈 Plot 3: Top Directors Comparison
...
## 📈 Plot 5: Year-by-Year Comprehensive Comparison
...
6. Create pivot table: countries × (platform, type)
...
## 🔧 Common Functions & Methods Used Across All Plots
...
## 🎯 Key Insights These Visualizations Provide
